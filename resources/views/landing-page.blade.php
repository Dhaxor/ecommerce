   ...
   <body>
    ...
    <main>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="{{asset('img/'.$product->slug.'.jpg')}}" alt="">
                                    ...
                                    <h4><a href="{{ route('shop.show',$product->slug)}}">{{$product->details}}</a></h4>
                                        <div class="price">
                                            <ul>
                                                <li>$40.00</li>
        ...
        <div class="latest-wrapper lf-padding">
            <div class="latest-area latest-height d-flex align-items-center" data-background="{{asset("/img/collection/latest-offer.png")}}">
                <div class="container">
